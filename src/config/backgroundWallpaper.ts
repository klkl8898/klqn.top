...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/banner.png",
			"assets/images/DesktopWallpaper/b1.png",
			"assets/images/DesktopWallpaper/b2.png",
			"assets/images/DesktopWallpaper/b3.png",
			"assets/images/DesktopWallpaper/b4.png",
			"assets/images/DesktopWallpaper/b5.png",
			"assets/images/DesktopWallpaper/b6.png",
			"assets/images/DesktopWallpaper/b7.png",
			"assets/images/DesktopWallpaper/b8.png",
			"assets/images/DesktopWallpaper/b9.png",
			"assets/images/DesktopWallpaper/b10.png",
			"assets/images/DesktopWallpaper/b11.png",
			"assets/images/DesktopWallpaper/b12.png",
			"assets/images/DesktopWallpaper/b13.png",
			"assets/images/DesktopWallpaper/b14.png",
		],
		// 移动背景图片（支持单张或多张随机）
